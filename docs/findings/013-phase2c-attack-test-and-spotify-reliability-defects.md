...
| # | Defect | Status |
|---|---|---|
| 1 | squeezelite's systemd restart-rate limit exhausted by legitimate arbitration activity | **Fixed for real, 2026-09-11** — commit `2eec5f9`'s burst-limit raise (5→20) was a mitigation only, and was exceeded (24) under ordinary paced measurement; the actual race (systemd's own automatic restart running independently of the arbitration ladder) is now removed — see this section's own addendum |
