...
| [0074](0074-the-artist-page-holds-its-place.md) | The artist page holds the discography's place while About loads | **Accepted and built** — George, 2026-09-25. The biography arrives ~1.8 s after the page and shoved the discography down **373 px** - the same 373 for every artist, because `fitAbout` clamps the biography to what Popular leaves. The height `fitAbout` already aims at is now reserved while loading: **+373 down → 14 up**, and the page still compresses if nothing arrives. Phase 9 **criterion 0** |
