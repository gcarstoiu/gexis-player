...
| [0059](0059-artist-portraits-in-the-list.md) | Where the artist list's portraits come from | **Proposed** — George asked for options, 2026-09-23. fanart over LMS was decided on 2026-09-18 and the artist *page* already does it; the **list** does not. LMS has no MusicBrainz id for this library ([Finding 054](../findings/054-what-lms-knows-about-artist-identity.md)), so the id comes from search by name at 1.5-5.3 s an artist. The list holds **album** artists - 917, of which **89 are unresolved**, so the sweep is minutes rather than hours and **one background pass** is recommended. Album art: LMS has a cover for 4,412 of 4,567; filling the 155 gaps is ~9 minutes, replacing them all is 4-7 hours |
